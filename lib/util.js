var util = {
  ...
  commonTwitter: "rt tonight today new tomorrow make again work thing last love good time next gonna real off never night like know people day think back why name need want life things",
  isInString: function(needle, haystack){
    return (' '+haystack+' ').indexOf(' '+needle+' ') > -1;
  },
  isCommon: function(input) {
    return util.isInString(input.toLowerCase(),
      util.commonEnglish + util.commonTwitter);
  },
